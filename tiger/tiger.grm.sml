...
fn (i392,defaultPos,stack,
    (()):arg) =>
case (i392,stack)
of  ( 0, ( ( _, ( MlyValue.EXPS EXPS, EXPS1left, EXPS1right)) :: rest671)) => let val  result = MlyValue.PROGRAM ((*#line 116.35 "tiger.grm"*)EXPS(*#line 532.1 "tiger.grm.sml"*)
)
 in ( LrTable.NT 0, ( result, EXPS1left, EXPS1right), rest671)
end
|  ( 1, ( rest671)) => let val  result = MlyValue.EXPS ((*#line 123.36 "tiger.grm"*) []           (*#line 536.1 "tiger.grm.sml"*)
)
 in ( LrTable.NT 7, ( result, defaultPos, defaultPos), rest671)
end
|  ( 2, ( ( _, ( MlyValue.EXPS2 EXPS2, _, EXPS21right)) :: ( _, ( MlyValue.EXP EXP, EXP1left, _)) :: rest671)) => let val  result = MlyValue.EXPS ((*#line 124.36 "tiger.grm"*) EXP :: EXPS2 (*#line 540.1 "tiger.grm.sml"*)
)
 in ( LrTable.NT 7, ( result, EXP1left, EXPS21right), rest671)
end
|  ( 3, ( rest671)) => let val  result = MlyValue.EXPS2 ((*#line 125.36 "tiger.grm"*) []           (*#line 544.1 "tiger.grm.sml"*)
)
 in ( LrTable.NT 8, ( result, defaultPos, defaultPos), rest671)
end
|  ( 4, ( ( _, ( MlyValue.EXPS2 EXPS2, _, EXPS21right)) :: ( _, ( MlyValue.EXP EXP, _, _)) :: ( _, ( _, SEMICOLON1left, _)) :: rest671)) => let val  result = MlyValue.EXPS2 ((*#line 126.36 "tiger.grm"*) EXP :: EXPS2 (*#line 548.1 "tiger.grm.sml"*)
)
 in ( LrTable.NT 8, ( result, SEMICOLON1left, EXPS21right), rest671)
end
|  ( 5, ( ( _, ( MlyValue.CONST_INT CONST_INT, CONST_INT1left, CONST_INT1right)) :: rest671)) => let val  result = MlyValue.EXP ((*#line 131.46 "tiger.grm"*) Tiger.IExpr CONST_INT                    (*#line 552.1 "tiger.grm.sml"*)
)
 in ( LrTable.NT 2, ( result, CONST_INT1left, CONST_INT1right), rest671)
end
|  ( 6, ( ( _, ( MlyValue.CONST_STR CONST_STR, CONST_STR1left, CONST_STR1right)) :: rest671)) => let val  result = MlyValue.EXP ((*#line 132.46 "tiger.grm"*) Tiger.SExpr CONST_STR                    (*#line 556.1 "tiger.grm.sml"*)
)
 in ( LrTable.NT 2, ( result, CONST_STR1left, CONST_STR1right), rest671)
end
|  ( 7, ( ( _, ( _, NIL1left, NIL1right)) :: rest671)) => let val  result = MlyValue.EXP ((*#line 133.46 "tiger.grm"*) Tiger.NilExpr                            (*#line 560.1 "tiger.grm.sml"*)
)
 in ( LrTable.NT 2, ( result, NIL1left, NIL1right), rest671)
end
|  ( 8, ( ( _, ( MlyValue.EXP EXP2, _, EXP2right)) :: _ :: _ :: ( _, ( MlyValue.EXP EXP1, _, _)) :: _ :: ( _, ( MlyValue.ID ID, ID1left, _)) :: rest671)) => let val  result = MlyValue.EXP ((*#line 134.46 "tiger.grm"*) Tiger.ConvArrAST (Tiger.Sub ID) EXP1 EXP2(*#line 564.1 "tiger.grm.sml"*)
)
 in ( LrTable.NT 2, ( result, ID1left, EXP2right), rest671)
end
|  ( 9, ( ( _, ( MlyValue.LVALUE LVALUE, LVALUE1left, LVALUE1right)) :: rest671)) => let val  result = MlyValue.EXP ((*#line 135.46 "tiger.grm"*) Tiger.LValueExpr LVALUE                  (*#line 568.1 "tiger.grm.sml"*)
)
 in ( LrTable.NT 2, ( result, LVALUE1left, LVALUE1right), rest671)
end
|  ( 10, ( ( _, ( _, _, RBRAC_C1right)) :: ( _, ( MlyValue.FIELD FIELD, _, _)) :: _ :: ( _, ( MlyValue.ID ID, ID1left, _)) :: rest671)) => let val  result = MlyValue.EXP ((*#line 136.46 "tiger.grm"*) Tiger.ConvRecAST (Tiger.Sub ID) FIELD    (*#line 572.1 "tiger.grm.sml"*)
)
 in ( LrTable.NT 2, ( result, ID1left, RBRAC_C1right), rest671)
end
|  ( 11, ( ( _, ( _, _, RBRAC_R1right)) :: ( _, ( MlyValue.PARAM PARAM, _, _)) :: _ :: ( _, ( MlyValue.ID ID, ID1left, _)) :: rest671)) => let val  result = MlyValue.EXP ((*#line 137.46 "tiger.grm"*) Tiger.ConvFunCallAST ID PARAM            (*#line 576.1 "tiger.grm.sml"*)
)
 in ( LrTable.NT 2, ( result, ID1left, RBRAC_R1right), rest671)
end
|  ( 12, ( ( _, ( MlyValue.EXP EXP, _, EXP1right)) :: ( _, ( _, MINUS1left, _)) :: rest671)) => let val  result = MlyValue.EXP ((*#line 139.46 "tiger.grm"*) Tiger.NegationExpr EXP                   (*#line 580.1 "tiger.grm.sml"*)
)
 in ( LrTable.NT 2, ( result, MINUS1left, EXP1right), rest671)
end
|  ( 13, ( ( _, ( MlyValue.ARITH ARITH, ARITH1left, ARITH1right)) :: rest671)) => let val  result = MlyValue.EXP ((*#line 140.46 "tiger.grm"*) ARITH                                    (*#line 584.1 "tiger.grm.sml"*)
)
 in ( LrTable.NT 2, ( result, ARITH1left, ARITH1right), rest671)
end
|  ( 14, ( ( _, ( _, _, RBRAC_R1right)) :: ( _, ( MlyValue.EXPS EXPS, _, _)) :: ( _, ( _, LBRAC_R1left, _)) :: rest671)) => let val  result = MlyValue.EXP ((*#line 141.46 "tiger.grm"*) Tiger.SeqExpr EXPS                       (*#line 588.1 "tiger.grm.sml"*)
)
 in ( LrTable.NT 2, ( result, LBRAC_R1left, RBRAC_R1right), rest671)
end
|  ( 15, ( ( _, ( MlyValue.EXP EXP, _, EXP1right)) :: _ :: ( _, ( MlyValue.LVALUE LVALUE, LVALUE1left, _)) :: rest671)) => let val  result = MlyValue.EXP ((*#line 142.46 "tiger.grm"*) Tiger.AssignExpr (LVALUE,EXP)            (*#line 592.1 "tiger.grm.sml"*)
)
 in ( LrTable.NT 2, ( result, LVALUE1left, EXP1right), rest671)
end
|  ( 16, ( ( _, ( MlyValue.EXP EXP3, _, EXP3right)) :: _ :: ( _, ( MlyValue.EXP EXP2, _, _)) :: _ :: ( _, ( MlyValue.EXP EXP1, _, _)) :: ( _, ( _, IF1left, _)) :: rest671)) => let val  result = MlyValue.EXP ((*#line 143.46 "tiger.grm"*) Tiger.ConvIfElseAST EXP1 EXP2 EXP3       (*#line 596.1 "tiger.grm.sml"*)
)
 in ( LrTable.NT 2, ( result, IF1left, EXP3right), rest671)
end
|  ( 17, ( ( _, ( MlyValue.EXP EXP2, _, EXP2right)) :: _ :: ( _, ( MlyValue.EXP EXP1, _, _)) :: ( _, ( _, IF1left, _)) :: rest671)) => let val  result = MlyValue.EXP ((*#line 144.46 "tiger.grm"*) Tiger.ConvIfAST EXP1 EXP2                (*#line 600.1 "tiger.grm.sml"*)
)
 in ( LrTable.NT 2, ( result, IF1left, EXP2right), rest671)
end
|  ( 18, ( ( _, ( MlyValue.EXP EXP2, _, EXP2right)) :: _ :: ( _, ( MlyValue.EXP EXP1, _, _)) :: ( _, ( _, WHILE1left, _)) :: rest671)) => let val  result = MlyValue.EXP ((*#line 145.46 "tiger.grm"*) Tiger.ConvWhileAST EXP1 EXP2             (*#line 604.1 "tiger.grm.sml"*)
)
 in ( LrTable.NT 2, ( result, WHILE1left, EXP2right), rest671)
end
|  ( 19, ( ( _, ( MlyValue.EXP EXP3, _, EXP3right)) :: _ :: ( _, ( MlyValue.EXP EXP2, _, _)) :: _ :: ( _, ( MlyValue.EXP EXP1, _, _)) :: _ :: ( _, ( MlyValue.ID ID, _, _)) :: ( _, ( _, FOR1left, _)) :: rest671)) => let val  result = MlyValue.EXP ((*#line 146.46 "tiger.grm"*) Tiger.ConvForAST ID EXP1 EXP2 EXP3       (*#line 608.1 "tiger.grm.sml"*)
)
 in ( LrTable.NT 2, ( result, FOR1left, EXP3right), rest671)
end
|  ( 20, ( ( _, ( _, BREAK1left, BREAK1right)) :: rest671)) => let val  result = MlyValue.EXP ((*#line 147.46 "tiger.grm"*) Tiger.BreakExpr                          (*#line 612.1 "tiger.grm.sml"*)
)
 in ( LrTable.NT 2, ( result, BREAK1left, BREAK1right), rest671)
end
|  ( 21, ( ( _, ( _, _, END1right)) :: ( _, ( MlyValue.EXPS EXPS, _, _)) :: _ :: ( _, ( MlyValue.DECS DECS, _, _)) :: ( _, ( _, LET1left, _)) :: rest671)) => let val  result = MlyValue.EXP ((*#line 148.46 "tiger.grm"*) Tiger.ConvLetAST DECS EXPS               (*#line 616.1 "tiger.grm.sml"*)
)
 in ( LrTable.NT 2, ( result, LET1left, END1right), rest671)
end
|  ( 22, ( rest671)) => let val  result = MlyValue.DECS ((*#line 157.43 "tiger.grm"*) []           (*#line 620.1 "tiger.grm.sml"*)
)
 in ( LrTable.NT 6, ( result, defaultPos, defaultPos), rest671)
end
|  ( 23, ( ( _, ( MlyValue.DECS DECS, _, DECS1right)) :: ( _, ( MlyValue.DEC DEC, DEC1left, _)) :: rest671)) => let val  result = MlyValue.DECS ((*#line 158.43 "tiger.grm"*) DEC :: DECS  (*#line 624.1 "tiger.grm.sml"*)
)
 in ( LrTable.NT 6, ( result, DEC1left, DECS1right), rest671)
end
|  ( 24, ( ( _, ( MlyValue.TY TY, _, TY1right)) :: _ :: ( _, ( MlyValue.ID ID, _, _)) :: ( _, ( _, TYPE1left, _)) :: rest671)) => let val  result = MlyValue.DEC ((*#line 160.43 "tiger.grm"*) Tiger.TypeDec (ID,TY)                    (*#line 628.1 "tiger.grm.sml"*)
)
 in ( LrTable.NT 1, ( result, TYPE1left, TY1right), rest671)
end
|  ( 25, ( ( _, ( MlyValue.EXP EXP, _, EXP1right)) :: _ :: ( _, ( MlyValue.ID ID, _, _)) :: ( _, ( _, VAR1left, _)) :: rest671)) => let val  result = MlyValue.DEC ((*#line 161.43 "tiger.grm"*) Tiger.ConvVarDec ID EXP                  (*#line 632.1 "tiger.grm.sml"*)
)
 in ( LrTable.NT 1, ( result, VAR1left, EXP1right), rest671)
end
|  ( 26, ( ( _, ( MlyValue.EXP EXP, _, EXP1right)) :: _ :: ( _, ( MlyValue.ID ID2, _, _)) :: _ :: ( _, ( MlyValue.ID ID1, _, _)) :: ( _, ( _, VAR1left, _)) :: rest671)) => let val  result = MlyValue.DEC ((*#line 162.43 "tiger.grm"*) Tiger.ConvVarDecTy ID1 (Tiger.TC ID2) EXP(*#line 636.1 "tiger.grm.sml"*)
)
 in ( LrTable.NT 1, ( result, VAR1left, EXP1right), rest671)
end
|  ( 27, ( ( _, ( MlyValue.FUNCDEF FUNCDEF, FUNCDEF1left, FUNCDEF1right)) :: rest671)) => let val  result = MlyValue.DEC ((*#line 163.43 "tiger.grm"*) Tiger.FuncDecs FUNCDEF                   (*#line 640.1 "tiger.grm.sml"*)
)
 in ( LrTable.NT 1, ( result, FUNCDEF1left, FUNCDEF1right), rest671)
end
|  ( 28, ( ( _, ( MlyValue.EXP EXP, _, EXP1right)) :: _ :: _ :: ( _, ( MlyValue.TYFIELDS TYFIELDS, _, _)) :: _ :: ( _, ( MlyValue.ID ID, _, _)) :: ( _, ( _, FUNCTION1left, _)) :: rest671)) => let val  result = MlyValue.FUNCDEF ((*#line 166.67 "tiger.grm"*) Tiger.ConvFunDecAST ID TYFIELDS EXP                      (*#line 644.1 "tiger.grm.sml"*)
)
 in ( LrTable.NT 12, ( result, FUNCTION1left, EXP1right), rest671)
end
|  ( 29, ( ( _, ( MlyValue.EXP EXP, _, EXP1right)) :: _ :: ( _, ( MlyValue.ID ID2, _, _)) :: _ :: _ :: ( _, ( MlyValue.TYFIELDS TYFIELDS, _, _)) :: _ :: ( _, ( MlyValue.ID ID1, _, _)) :: ( _, ( _, FUNCTION1left, _)) :: rest671)) => let val  result = MlyValue.FUNCDEF ((*#line 167.67 "tiger.grm"*) Tiger.ConvFunDecRetAST ID1 TYFIELDS (Tiger.Sub ID2) EXP  (*#line 648.1 "tiger.grm.sml"*)
)
 in ( LrTable.NT 12, ( result, FUNCTION1left, EXP1right), rest671)
end
|  ( 30, ( rest671)) => let val  result = MlyValue.TYFIELDS ((*#line 177.46 "tiger.grm"*) Tiger.TF([])                                  (*#line 652.1 "tiger.grm.sml"*)
)
 in ( LrTable.NT 9, ( result, defaultPos, defaultPos), rest671)
end
|  ( 31, ( ( _, ( MlyValue.TYFIELDS2 TYFIELDS2, _, TYFIELDS21right)) :: ( _, ( MlyValue.ID ID2, _, _)) :: _ :: ( _, ( MlyValue.ID ID1, ID1left, _)) :: rest671)) => let val  result = MlyValue.TYFIELDS ((*#line 178.46 "tiger.grm"*) Tiger.TF((ID1 , (Tiger.TC ID2)) :: TYFIELDS2) (*#line 656.1 "tiger.grm.sml"*)
)
 in ( LrTable.NT 9, ( result, ID1left, TYFIELDS21right), rest671)
end
|  ( 32, ( rest671)) => let val  result = MlyValue.TYFIELDS2 ((*#line 179.46 "tiger.grm"*) []                                  (*#line 660.1 "tiger.grm.sml"*)
)
 in ( LrTable.NT 10, ( result, defaultPos, defaultPos), rest671)
end
|  ( 33, ( ( _, ( MlyValue.TYFIELDS2 TYFIELDS2, _, TYFIELDS21right)) :: ( _, ( MlyValue.ID ID2, _, _)) :: _ :: ( _, ( MlyValue.ID ID1, _, _)) :: ( _, ( _, COMMA1left, _)) :: rest671)) => let val  result = MlyValue.TYFIELDS2 ((*#line 180.46 "tiger.grm"*) (ID1 , (Tiger.TC ID2)) :: TYFIELDS2 (*#line 664.1 "tiger.grm.sml"*)
)
 in ( LrTable.NT 10, ( result, COMMA1left, TYFIELDS21right), rest671)
end
|  ( 34, ( ( _, ( MlyValue.ID ID, ID1left, ID1right)) :: rest671)) => let val  result = MlyValue.TY ((*#line 183.46 "tiger.grm"*) Tiger.AlreadyTy (Tiger.TC ID) (*#line 668.1 "tiger.grm.sml"*)
)
 in ( LrTable.NT 11, ( result, ID1left, ID1right), rest671)
end
|  ( 35, ( ( _, ( _, _, RBRAC_C1right)) :: ( _, ( MlyValue.TYFIELDS TYFIELDS, _, _)) :: ( _, ( _, LBRAC_C1left, _)) :: rest671)) => let val  result = MlyValue.TY ((*#line 184.46 "tiger.grm"*) Tiger.SeqTy TYFIELDS          (*#line 672.1 "tiger.grm.sml"*)
)
 in ( LrTable.NT 11, ( result, LBRAC_C1left, RBRAC_C1right), rest671)
end
|  ( 36, ( ( _, ( MlyValue.ID ID, _, ID1right)) :: _ :: ( _, ( _, ARRAY1left, _)) :: rest671)) => let val  result = MlyValue.TY ((*#line 185.46 "tiger.grm"*) Tiger.ArrayTy (Tiger.TC ID)   (*#line 676.1 "tiger.grm.sml"*)
)
 in ( LrTable.NT 11, ( result, ARRAY1left, ID1right), rest671)
end
|  ( 37, ( ( _, ( MlyValue.EXP EXP2, _, EXP2right)) :: _ :: ( _, ( MlyValue.EXP EXP1, EXP1left, _)) :: rest671)) => let val  result = MlyValue.ARITH ((*#line 191.38 "tiger.grm"*) Tiger.plus EXP1 EXP2           (*#line 680.1 "tiger.grm.sml"*)
)
 in ( LrTable.NT 14, ( result, EXP1left, EXP2right), rest671)
end
|  ( 38, ( ( _, ( MlyValue.EXP EXP2, _, EXP2right)) :: _ :: ( _, ( MlyValue.EXP EXP1, EXP1left, _)) :: rest671)) => let val  result = MlyValue.ARITH ((*#line 192.38 "tiger.grm"*) Tiger.minus EXP1 EXP2          (*#line 684.1 "tiger.grm.sml"*)
)
 in ( LrTable.NT 14, ( result, EXP1left, EXP2right), rest671)
end
|  ( 39, ( ( _, ( MlyValue.EXP EXP2, _, EXP2right)) :: _ :: ( _, ( MlyValue.EXP EXP1, EXP1left, _)) :: rest671)) => let val  result = MlyValue.ARITH ((*#line 193.38 "tiger.grm"*) Tiger.mul EXP1 EXP2            (*#line 688.1 "tiger.grm.sml"*)
)
 in ( LrTable.NT 14, ( result, EXP1left, EXP2right), rest671)
end
|  ( 40, ( ( _, ( MlyValue.EXP EXP2, _, EXP2right)) :: _ :: ( _, ( MlyValue.EXP EXP1, EXP1left, _)) :: rest671)) => let val  result = MlyValue.ARITH ((*#line 194.38 "tiger.grm"*) Tiger.divv EXP1 EXP2           (*#line 692.1 "tiger.grm.sml"*)
)
 in ( LrTable.NT 14, ( result, EXP1left, EXP2right), rest671)
end
|  ( 41, ( ( _, ( MlyValue.EXP EXP2, _, EXP2right)) :: _ :: ( _, ( MlyValue.EXP EXP1, EXP1left, _)) :: rest671)) => let val  result = MlyValue.ARITH ((*#line 195.38 "tiger.grm"*) Tiger.equals EXP1 EXP2         (*#line 696.1 "tiger.grm.sml"*)
)
 in ( LrTable.NT 14, ( result, EXP1left, EXP2right), rest671)
end
|  ( 42, ( ( _, ( MlyValue.EXP EXP2, _, EXP2right)) :: _ :: ( _, ( MlyValue.EXP EXP1, EXP1left, _)) :: rest671)) => let val  result = MlyValue.ARITH ((*#line 196.38 "tiger.grm"*) Tiger.angbrac EXP1 EXP2        (*#line 700.1 "tiger.grm.sml"*)
)
 in ( LrTable.NT 14, ( result, EXP1left, EXP2right), rest671)
end
|  ( 43, ( ( _, ( MlyValue.EXP EXP2, _, EXP2right)) :: _ :: ( _, ( MlyValue.EXP EXP1, EXP1left, _)) :: rest671)) => let val  result = MlyValue.ARITH ((*#line 197.38 "tiger.grm"*) Tiger.greaterThan EXP1 EXP2    (*#line 704.1 "tiger.grm.sml"*)
)
 in ( LrTable.NT 14, ( result, EXP1left, EXP2right), rest671)
end
|  ( 44, ( ( _, ( MlyValue.EXP EXP2, _, EXP2right)) :: _ :: ( _, ( MlyValue.EXP EXP1, EXP1left, _)) :: rest671)) => let val  result = MlyValue.ARITH ((*#line 198.38 "tiger.grm"*) Tiger.lessThan EXP1 EXP2       (*#line 708.1 "tiger.grm.sml"*)
)
 in ( LrTable.NT 14, ( result, EXP1left, EXP2right), rest671)
end
|  ( 45, ( ( _, ( MlyValue.EXP EXP2, _, EXP2right)) :: _ :: ( _, ( MlyValue.EXP EXP1, EXP1left, _)) :: rest671)) => let val  result = MlyValue.ARITH ((*#line 199.38 "tiger.grm"*) Tiger.lessEqualThan EXP1 EXP2  (*#line 712.1 "tiger.grm.sml"*)
)
 in ( LrTable.NT 14, ( result, EXP1left, EXP2right), rest671)
end
|  ( 46, ( ( _, ( MlyValue.EXP EXP2, _, EXP2right)) :: _ :: ( _, ( MlyValue.EXP EXP1, EXP1left, _)) :: rest671)) => let val  result = MlyValue.ARITH ((*#line 200.38 "tiger.grm"*) Tiger.greatEqualThan EXP1 EXP2 (*#line 716.1 "tiger.grm.sml"*)
)
 in ( LrTable.NT 14, ( result, EXP1left, EXP2right), rest671)
end
|  ( 47, ( ( _, ( MlyValue.EXP EXP2, _, EXP2right)) :: _ :: ( _, ( MlyValue.EXP EXP1, EXP1left, _)) :: rest671)) => let val  result = MlyValue.ARITH ((*#line 201.38 "tiger.grm"*) Tiger.andd EXP1 EXP2           (*#line 720.1 "tiger.grm.sml"*)
)
 in ( LrTable.NT 14, ( result, EXP1left, EXP2right), rest671)
end
|  ( 48, ( ( _, ( MlyValue.EXP EXP2, _, EXP2right)) :: _ :: ( _, ( MlyValue.EXP EXP1, EXP1left, _)) :: rest671)) => let val  result = MlyValue.ARITH ((*#line 202.38 "tiger.grm"*) Tiger.orr EXP1 EXP2            (*#line 724.1 "tiger.grm.sml"*)
)
 in ( LrTable.NT 14, ( result, EXP1left, EXP2right), rest671)
end
|  ( 49, ( rest671)) => let val  result = MlyValue.FIELD ((*#line 210.36 "tiger.grm"*) []                   (*#line 728.1 "tiger.grm.sml"*)
)
 in ( LrTable.NT 3, ( result, defaultPos, defaultPos), rest671)
end
|  ( 50, ( ( _, ( MlyValue.FIELD2 FIELD2, _, FIELD21right)) :: ( _, ( MlyValue.EXP EXP, _, _)) :: _ :: ( _, ( MlyValue.ID ID, ID1left, _)) :: rest671)) => let val  result = MlyValue.FIELD ((*#line 211.36 "tiger.grm"*) (ID , EXP) :: FIELD2 (*#line 732.1 "tiger.grm.sml"*)
)
 in ( LrTable.NT 3, ( result, ID1left, FIELD21right), rest671)
end
|  ( 51, ( rest671)) => let val  result = MlyValue.FIELD2 ((*#line 212.36 "tiger.grm"*) []                   (*#line 736.1 "tiger.grm.sml"*)
)
 in ( LrTable.NT 15, ( result, defaultPos, defaultPos), rest671)
end
|  ( 52, ( ( _, ( MlyValue.FIELD2 FIELD2, _, FIELD21right)) :: ( _, ( MlyValue.EXP EXP, _, _)) :: _ :: ( _, ( MlyValue.ID ID, _, _)) :: ( _, ( _, COMMA1left, _)) :: rest671)) => let val  result = MlyValue.FIELD2 ((*#line 213.36 "tiger.grm"*) (ID , EXP) :: FIELD2 (*#line 740.1 "tiger.grm.sml"*)
)
 in ( LrTable.NT 15, ( result, COMMA1left, FIELD21right), rest671)
end
|  ( 53, ( rest671)) => let val  result = MlyValue.PARAM ((*#line 222.38 "tiger.grm"*) []            (*#line 744.1 "tiger.grm.sml"*)
)
 in ( LrTable.NT 4, ( result, defaultPos, defaultPos), rest671)
end
|  ( 54, ( ( _, ( MlyValue.PARAM2 PARAM2, _, PARAM21right)) :: ( _, ( MlyValue.EXP EXP, EXP1left, _)) :: rest671)) => let val  result = MlyValue.PARAM ((*#line 223.38 "tiger.grm"*) EXP :: PARAM2 (*#line 748.1 "tiger.grm.sml"*)
)
 in ( LrTable.NT 4, ( result, EXP1left, PARAM21right), rest671)
end
|  ( 55, ( rest671)) => let val  result = MlyValue.PARAM2 ((*#line 224.38 "tiger.grm"*) []            (*#line 752.1 "tiger.grm.sml"*)
)
 in ( LrTable.NT 5, ( result, defaultPos, defaultPos), rest671)
end
|  ( 56, ( ( _, ( MlyValue.PARAM2 PARAM2, _, PARAM21right)) :: ( _, ( MlyValue.EXP EXP, _, _)) :: ( _, ( _, COMMA1left, _)) :: rest671)) => let val  result = MlyValue.PARAM2 ((*#line 225.38 "tiger.grm"*) EXP :: PARAM2 (*#line 756.1 "tiger.grm.sml"*)
)
 in ( LrTable.NT 5, ( result, COMMA1left, PARAM21right), rest671)
end
|  ( 57, ( ( _, ( MlyValue.ID ID, ID1left, ID1right)) :: rest671)) => let val  result = MlyValue.LVALUE ((*#line 228.42 "tiger.grm"*) Tiger.SimpleVar ID                       (*#line 760.1 "tiger.grm.sml"*)
)
 in ( LrTable.NT 13, ( result, ID1left, ID1right), rest671)
end
|  ( 58, ( ( _, ( MlyValue.ID ID, _, ID1right)) :: _ :: ( _, ( MlyValue.LVALUE LVALUE, LVALUE1left, _)) :: rest671)) => let val  result = MlyValue.LVALUE ((*#line 229.42 "tiger.grm"*) Tiger.FeildVar (LVALUE , ID)             (*#line 764.1 "tiger.grm.sml"*)
)
 in ( LrTable.NT 13, ( result, LVALUE1left, ID1right), rest671)
end
|  ( 59, ( ( _, ( _, _, RBRAC_SQ1right)) :: ( _, ( MlyValue.EXP EXP, _, _)) :: _ :: ( _, ( MlyValue.ID ID, ID1left, _)) :: rest671)) => let val  result = MlyValue.LVALUE ((*#line 230.42 "tiger.grm"*) Tiger.ArrEl ((Tiger.SimpleVar ID) , EXP) (*#line 768.1 "tiger.grm.sml"*)
)
 in ( LrTable.NT 13, ( result, ID1left, RBRAC_SQ1right), rest671)
end
|  ( 60, ( ( _, ( _, _, RBRAC_SQ1right)) :: ( _, ( MlyValue.EXP EXP, _, _)) :: _ :: ( _, ( MlyValue.LVALUE LVALUE, LVALUE1left, _)) :: rest671)) => let val  result = MlyValue.LVALUE ((*#line 231.42 "tiger.grm"*) Tiger.ArrEl (LVALUE , EXP)               (*#line 772.1 "tiger.grm.sml"*)
)
